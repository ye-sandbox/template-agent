...
2. **Backlog é lista de títulos, não de specs.** Escreva a especificação completa só quando o item virar a tarefa ativa.
3. **Use a numeração semântica [XX.Y]:** Siga a convenção de fases descrita no `AGENTS.md`.
