...
| [`ui-port`](./ui-port/SKILL.md) | Stitch `code.html` **ou** HTML plano + contrato → app. Default **Svelte 5**: copiar `class`/keyframes/grid, extrair runes/peças. Ver [`ui-port/svelte.md`](./ui-port/svelte.md). Não regenerar Stitch. |
