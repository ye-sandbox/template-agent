...
- **Reinício da Contagem:** Com o lote arquivado no `ARCHIVE.md`, reinicie o contador de tarefas a partir de `[00.1]` (para discovery/mapeamento da nova versão) ou `[01.1]` (para os próximos fluxos de extração/endpoints).
